...
export function Header({ sidebarOpen, setSidebarOpen }: HeaderProps) {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 right-0 left-0 z-50 border-b border-white/5 bg-(--background)/90 backdrop-blur-md"
    >
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="p-2 text-white/90 hover:cursor-pointer hover:text-white md:hidden"
